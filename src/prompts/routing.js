...
const DRAFT_MESSAGE_PROMPT = (thread, leadProfile, routingDecision, asset, templateGuidance = null) => {
  ...
  const toneInstructions = {
    student_casual: 'You\'re peers — same age, same world. Casual, direct, short. Reference their uni, recruiting season, or career goals. Fragments fine.',
    professional_warm: 'Professional but warm. They have a few years experience — still relaxed but show you know your stuff. Reference their current role or firm.',
...
TONE: ${toneInstructions[leadProfile.seniorityTone] || toneInstructions.direct_peer}
