...
// Apply runtime settings (data/runtime-settings.json) BEFORE anything else
// reads env. Lets users set AIRTABLE_API_KEY etc. via the dashboard's Settings
// panel. .env still wins on conflict.
const settings = require('./services/settings');
settings.applyToEnv(settings.loadSettings());
...
app.use('/api/voice-dna', require('./routes/voice-dna'));
