...
function addTrainingPreference(pref) {
  ...
  pref.source = pref.source || 'training'; // default if missing
  ...
  // Auto-trigger voice DNA refresh if threshold reached (debounced inside the service)
  try {
...
// Update Avatar/IsCanonical on an existing record. Used by migration + manual canonical toggle.
