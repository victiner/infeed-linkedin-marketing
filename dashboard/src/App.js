  ...
  const simGhost = async () => {
    ...
    try {
      ...
      const updated = [
        ...
        { sender: 'us', text: data.ourMessage, _followUp: true },
      ];
      setSimThread(updated);
        ...
        <div>
          ...
          {simStarted && !simEnded && (
            <div style={{ display: 'flex', gap: 8, justifyContent: 'center', marginTop: 8, flexWrap: 'wrap' }}>
              ...
              {simThread.length > 0 && simThread[simThread.length - 1].sender === 'us' && (
                <button onClick={simGhost} disabled={simLoading || !simLead}
                  title="Simulate: lead read but didn't reply for 24h — generates a follow-up"
